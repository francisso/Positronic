...
```bash
grep -o '[0-9]*%' /tmp/Codex/-home-vertix-dev-positronic/tasks/<task_id>.output | tail -1
tail -50 /tmp/Codex/-home-vertix-dev-positronic/tasks/<task_id>.output
grep -i "error\|complete\|finished" /tmp/Codex/-home-vertix-dev-positronic/tasks/<task_id>.output
```
